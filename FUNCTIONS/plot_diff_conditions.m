function [all_trials_oddbdiff_hi, all_trials_oddbdiff_lo] = plot_diff_conditions(folderPath, row_nr, savefig)
...
title(['Noddball-oddball (Mean±SEM) per strength: ', str_array(row_nr)]);
legend({'Cond 1 ± SEM','Cond 2 ± SEM'}, 'Location','best');
grid on; box off;


%% Save figure
fileName = char("fig_" + str_array(row_nr)); 
