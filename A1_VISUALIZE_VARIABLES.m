%% VISUALIZE A TRIAL
% this script is not important, its only to explore where in time certain
% events happen, to get a feel for the huge amount of variables

% dragdrop example data
...
% add random variable to see where in time it appears
% comment this out if you dont need
% scatter(stimulusStartTimeP(trial), 0, 70, 'r', 'filled');
